...
public class VideoService {
    ...
    public byte[] getJobBlogPhotoById(Long videoId) throws Exception {
        Video video = videoRepo.findById(videoId).orElseThrow(() -> new Exception("Video for blog Offer not found"));
